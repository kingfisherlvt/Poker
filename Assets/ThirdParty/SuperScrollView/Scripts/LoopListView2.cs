...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        /// <summary>        /// 头部出现菊花        /// </summary>
        public System.Action mOnUpRefreshDragAction = null;
        /// <summary>        /// 底部出现菊花        /// </summary>
        public System.Action mOnDownMoreDragAction = null;
        ...
        */
        ...
        public virtual void OnBeginDrag(PointerEventData eventData)
        {
            ...
            this.mPosY = eventData.position.y;
            mIsDraging = true;
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            if (this.mPosY > eventData.position.y)
            {
                if (this.mOnUpRefreshDragAction != null)
                {
                    mOnUpRefreshDragAction();
                }
                //Debug.Log("顶部的菊花");
            }
            else if (this.mPosY < eventData.position.y)
            {
                if (this.mOnUpRefreshDragAction != null)
                {
                    mOnDownMoreDragAction();
                }
                //  Debug.Log("下面的菊花");
            }
