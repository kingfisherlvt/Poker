...
namespace xcharts
{
    ...
    public class ThemeInfo
    {
        ...
        public static ThemeInfo Default
        {
            get
            {
                return new ThemeInfo()
                {
                    ...
                    tempId = Theme.Default,
                    fontsize = 30,
                    colorPalette = new Color[]
                    {
                        new Color32(233, 191, 128, 255),
        ...
        public static ThemeInfo AlphaNull
        {
            get
            {
                return new ThemeInfo()
                {
                    ...
                    axisLineColor = GetColor("#514D4D"),
                    axisSplitLineColor = GetColor("#AB9999"),
                    tempId = Theme.AlphaNull,
                    fontsize = 30,
                    colorPalette = new Color[]
                    {
                        new Color32(233, 191, 128, 0)                      
                    }
                };
            }
        }
        ...
        public static ThemeInfo Dark
        {
            get
            {
                return new ThemeInfo()
                {
                    font = Resources.GetBuiltinResource<Font>("Arial.ttf"),
                    unableColor = GetColor("#cccccc"),
                    backgroundColor = new Color32(34, 34, 34, 0),
