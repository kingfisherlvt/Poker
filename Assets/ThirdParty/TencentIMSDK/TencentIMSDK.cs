...
namespace com.tencent.imsdk.unity
{
    public class TencentIMSDK
    {
        ...
        public static RecvNewMsgCallback RecvNewMsgCallbackStore;
        public static void SetRecvNewMsgCallback(RecvNewMsgCallback cb) { RecvNewMsgCallbackStore = cb; }
        ...
        public static void AddRecvNewMsgCallback(RecvNewMsgCallback callback)
        {
            ...
            Debug.LogError("call IMNativeSDK.TIMAddRecvNewMsgCallback");
