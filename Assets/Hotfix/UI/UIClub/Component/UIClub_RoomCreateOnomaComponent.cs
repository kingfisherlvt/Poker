...
{
    [ObjectSystem]
    public class UIClub_RoomCreateOnomaComponentAwakeSystem : AwakeSystem<UIClub_RoomCreateOnomaComponent>
    {
        public override void Awake(UIClub_RoomCreateOnomaComponent self)
        {
            self.Awake();
        }
    }

    public class UIClub_RoomCreateOnomaComponent : UIBaseComponent
    {
        ...
        /// 带入USDT
        /// </summary>
        int[] draginArr = new int[] { 50, 100, 200, 300, 400 };
        /// <summary>
        /// 牌局时长(秒)
        /// </summary>
        ...
        public void Awake()
        {
            //默认当前界面内容
            isInit = false;
            rc = this.GetParent<UI>().GameObject.transform.Find("roomcreat_page3").GetComponent<ReferenceCollector>();
        ...
        public void OnStart(int ctype)
        {
            ...
            WEB2_room_omaha_create.RequestData omh = new WEB2_room_omaha_create.RequestData()
            {
                ...
                mode = element_xuezhan.toggle.isOn ? 1 : 0,
                ...
                rpath = (int)RoomPath.OmahaThanOff,
