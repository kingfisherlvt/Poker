...
{
    [ObjectSystem]
    public class UIClub_RoomCreateAofdzComponentSystem : AwakeSystem<UIClub_RoomCreateAofdzComponent>
    {
        public override void Awake(UIClub_RoomCreateAofdzComponent self)
        {
            self.Awake();
        }
    }

    public class UIClub_RoomCreateAofdzComponent : UIBaseComponent
    {
        ...
        float[] qianzhuType = new float[] { 0, 2, 5, 20, 30 };
        /// <summary>
        /// 最短上桌时间
        /// </summary>
        float[] shortTimeArr;
        ...
        public void Awake()
        {
            //默认当前界面内容
            isInit = false;
            rc = this.GetParent<UI>().GameObject.transform.Find("roomcreat_page4").GetComponent<ReferenceCollector>();
