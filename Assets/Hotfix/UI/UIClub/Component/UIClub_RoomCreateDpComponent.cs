...
namespace ETHotfix
{
    ...
    [ObjectSystem]
    public class UIClub_RoomCreateDpComponentSystem : AwakeSystem<UIClub_RoomCreateDpComponent>
    {
        public override void Awake(UIClub_RoomCreateDpComponent self)
        {
            self.Awake();
        }
    }

    public class UIClub_RoomCreateDpComponent : UIBaseComponent
    {
        ...
        public void Awake()
        {
            //默认当前界面内容
            isInit = false;
            rc = this.GetParent<UI>().GameObject.transform.Find("roomcreat_page6").GetComponent<ReferenceCollector>();
