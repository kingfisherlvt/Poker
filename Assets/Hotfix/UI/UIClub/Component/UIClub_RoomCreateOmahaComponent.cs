...
{
    [ObjectSystem]
    public class UIClub_RoomCreateOmahaComponentAwakeSystem : AwakeSystem<UIClub_RoomCreateOmahaComponent>
    {
        public override void Awake(UIClub_RoomCreateOmahaComponent self)
        {
            self.Awake();
        }
    }

    public class UIClub_RoomCreateOmahaComponent : UIBaseComponent
    {
        ...
        float[] qianzhuType = new float[3] { 0, 0.5f, 1 };
        /// <summary>
        /// 思考时间(秒)
        /// </summary>
        ...
        public void Awake()
        {
            //默认当前界面内容
            isInit = false;
            rc = this.GetParent<UI>().GameObject.transform.Find("roomcreat_page1").GetComponent<ReferenceCollector>();
