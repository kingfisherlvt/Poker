...
namespace ETHotfix
{
    ...
    [ObjectSystem]
    public class UIClub_RoomCreateAofDpComponentSystem : AwakeSystem<UIClub_RoomCreateAofDpComponent>
    {
        public override void Awake(UIClub_RoomCreateAofDpComponent self)
        {
            self.Awake();
        }
    }

    public class UIClub_RoomCreateAofDpComponent : UIBaseComponent
    {
        public ReferenceCollector rc;
        /// <summary>
        /// 前注
        /// </summary>
        int[] sizeblindArr = new int[] { 100, 200, 500, 1000, 2000, 3000 , 5000, 10000, 20000 , 30000 , 50000};
        /// <summary>
        /// 带入USDT
        /// </summary>
        ...
        ToggleElement element_toggle10;
        ...
        public void Awake()
        {
            //默认当前界面内容
            isInit = false;
            rc = this.GetParent<UI>().GameObject.transform.Find("roomcreat_page7").GetComponent<ReferenceCollector>();
        ...
        public override void OnShow(object obj)
        {
            ...
            if (!isInit)
            {
                ...
                assitent = rc.Get<GameObject>(UIClubAssitent.roomcreat_0_toggle_10);
                element_toggle10 = new ToggleElement(assitent.GetComponent<Toggle>(), assitent.transform.GetChild(1).gameObject.GetComponent<Text>());
            ...
            {
                Game.EventSystem.Run(UIClubEventIdType.CLUB_ROOMCREAT_TIP, 3);
            };
        ...
        public void OnStart(int ctype)
        {
            ...
            //新接口
            WEB2_room_dp_create.RequestData rdz = new WEB2_room_dp_create.RequestData()
            {
                ...
                sdlon = rc.Get<GameObject>(UIClubAssitent.roomcreat_0_toggle_10).GetComponent<Toggle>().isOn ? 1 : 0,//抓头改为庄家2倍前注
            ...
            isClickCreat = true;
            HttpRequestComponent.Instance.Send(WEB2_room_dp_create.API, WEB2_room_dp_create.Request(rdz), this.RoomCreatCall , null ,this.RoomCreatError);
        }
        ...
        void RoomCreatCall(string resData)
        {
            ...
            //新接口
            WEB2_room_dp_create.ResponseData res_dzroomData = WEB2_room_dp_create.Response(resData);
            ...
            else
            {
                ...
                UIComponent.Instance.Toast(res_dzroomData.status);
            }
        ...
        void UpdateBlindAndDragIn(int type , bool isEvent)
        {
            ...
            string str2 = StringHelper.ShowGold(sizeblind * 100, false);
            
            rc.Get<GameObject>(UIClubAssitent.mode_sizeblind_text_size).GetComponent<Text>().text = str1;
            rc.Get<GameObject>(UIClubAssitent.mode_sizeblind_text_dragin).GetComponent<Text>().text = str2;
        ...
        void SetDefaultConfig() {
            ...
            element_toggle10.toggle.isOn = GameCache.Instance.reconfigs[crt].element_toggle10_value;
        }
        ...
        void SaveConfig() {
            ...
            GameCache.Instance.reconfigs[crt].element_toggle10_value = element_toggle10.toggle.isOn;
        }
        #endregion
