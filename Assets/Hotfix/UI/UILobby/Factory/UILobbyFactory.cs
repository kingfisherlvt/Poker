...
namespace ETHotfix
{
    ...
    public class UILobbyFactory : IUIFactoryExtend
    {
        public UI Create(Scene scene, string type, GameObject gameObject)
        {
	        try
	        {
				...
				ui.AddUIBaseComponent<UILobbyComponent>();
                AddSubComponent(ui);
                return ui;
	        }
	        catch (Exception e)
	    ...
	    {
            ui.AddComponent<DBAreaComponent>();
        }
    }


    [UIFactory(UIType.UILobby_Menu)]
    public class UILobby_MenuFactory : IUIFactoryExtend
    {
        public async Task<UI> CreateAsync(Scene scene, string type, GameObject parent)
        {
            try
            {
                ...
                instanObj.layer = LayerMask.NameToLayer(LayerNames.UI);
                UI ui = ComponentFactory.Create<UI, GameObject>(instanObj);
                ui.AddUIBaseComponent<UILobby_MenuComponent>();

                ui.AddComponent<SystemMesComponent>();
                ui.AddComponent<UILobby_Triggle>();
                //system mes
                return ui;
            }
            catch (Exception e)
