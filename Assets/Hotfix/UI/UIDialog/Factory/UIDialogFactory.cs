...
namespace ETHotfix
{
	[UIFactory(UIType.UIDialog)]
	public class UIDialogFactory : IUIFactoryExtend
	{
    ...
    #region 
    [UIFactory(UIType.UIYaoDouEffect)]
    public class UIYaoDouEffectFactory : IUIFactoryExtend
    {
        public UI Create(Scene scene, string type, GameObject gameObject)
        {
            try
            {
                ...
                ui.AddUIBaseComponent<UIYaoDouEffectComponent>();
                AddSubComponent(ui);
                return ui;
            }
            catch (Exception e)
