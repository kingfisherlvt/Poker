...
namespace ETHotfix
{
    [UIFactory(UIType.UIFirstRechargeActivitySuccess)]
    public class UIFirstRechargeActivitySuccessFactory : IUIFactoryExtend
    {
        public UI Create(Scene scene, string type, GameObject gameObject)
        {
            try
            {
                ...
                ui.AddUIBaseComponent<UIFirstRechargeActivitySuccessComponent>();
