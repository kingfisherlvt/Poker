...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_ScrollRect_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_vertical_0);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_vertical", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_vertical_1);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_verticalScrollbar_4);


        }


        static StackObject* get_vertical_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_vertical_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* get_verticalScrollbar_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
