...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_StringHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("ToBigEndianUtf16", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ToBigEndianUtf16_0);
            args = new Type[]{typeof(System.String)};
        ...
        static StackObject* ToBigEndianUtf16_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ETModel.StringHelper.ToBigEndianUtf16(@str);
