...
namespace ILRuntime.Runtime.Generated
{
    unsafe class DG_Tweening_ShortcutExtensions46_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, DOAnchorPosX_0);
            ...
            app.RegisterCLRMethodRedirection(method, DOSizeDelta_1);
            ...
            app.RegisterCLRMethodRedirection(method, DOAnchorPosY_5);
            args = new Type[]{typeof(UnityEngine.UI.Text), typeof(System.Single), typeof(System.Single)};
            method = type.GetMethod("DOFade", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, DOFade_6);


        }


        static StackObject* DOAnchorPosX_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = DG.Tweening.ShortcutExtensions46.DOAnchorPosX(@target, @endValue, @duration, @snapping);
        ...
        static StackObject* DOSizeDelta_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 4);
            ...
            var result_of_this_method = DG.Tweening.ShortcutExtensions46.DOSizeDelta(@target, @endValue, @duration, @snapping);
        ...
        static StackObject* DOFade_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
        ...
        static StackObject* DOAnchorPosY_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 4);
            ...
            var result_of_this_method = DG.Tweening.ShortcutExtensions46.DOAnchorPosY(@target, @endValue, @duration, @snapping);
        ...
        static StackObject* DOFade_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
